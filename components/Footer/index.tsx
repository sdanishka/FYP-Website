        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    href="https://www.facebook.com/sahibzadadanish/"
                  ...
                  <a
                    href="https://twitter.com/sdkafridi"
                    aria-label="social-link"
                    target="_blank" rel="noopener noreferrer"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                  ...
                  <a
                    href="https://www.youtube.com/channel/UCIsHg2wNT4DxBzaoc-AmfXg"
                    aria-label="social-link"
                    target="_blank" rel="noopener noreferrer"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                  ...
                  <a
                    href="https://www.linkedin.com/in/danish-khan-afridi-a807b7291/"
                    aria-label="social-link"
                    target="_blank" rel="noopener noreferrer"
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              Auto Vision: A Machine Learning tool for Computer Vision Tasks
            </p>
          </div>
        </div>
